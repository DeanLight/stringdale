...
# %% auto 0
__all__ = ['logger', 'wrap_text', 'node_description', 'edge_description', 'graph_to_graphviz_spec', 'check_graphviz_installed',
           'draw_graphviz', 'draw_nx', 'is_ipython', 'display_in_ipython']
...
# %% ../nbs/001_visualization.ipynb 10
def draw_nx(g:nx.DiGraph,direction='TB',
    ...
    **kwargs):
    ...
    return draw_graphviz(node_kwargs,
        edge_kwargs,
        name=name,
        direction=direction,
        format=format,
...
# %% ../nbs/001_visualization.ipynb 13
from IPython.display import Markdown, display

# %% ../nbs/001_visualization.ipynb 14
def is_ipython():
    try:
