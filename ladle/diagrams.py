# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/005_diagrams.ipynb.
...
# %% ../nbs/005_diagrams.ipynb 8
logger = logging.getLogger(__name__)

# %% ../nbs/005_diagrams.ipynb 9
import asyncio
# ! pip install nest_asyncio
import nest_asyncio
nest_asyncio.apply()

# %% ../nbs/005_diagrams.ipynb 10
from IPython.display import display,Image,Markdown


# %% ../nbs/005_diagrams.ipynb 11
...
# %% ../nbs/005_diagrams.ipynb 13
from pydantic import BaseModel,ConfigDict,computed_field
from typing import Annotated

# %% ../nbs/005_diagrams.ipynb 14
class BaseModelExtra(BaseModel):
    model_config = ConfigDict(extra='allow')


# %% ../nbs/005_diagrams.ipynb 15
...
class DiagramSchema:
    ...
    def __call__(self):
        ...
        return Diagram(graph = schema_copy.graph,
        state_class = schema_copy.state_class,
        factored_graph = initialized_sub_diagrams_graph,
        start_node = schema_copy.start_node,
        end_node = schema_copy.end_node,
        name=schema_copy.name,
        type=schema_copy.type,
        anon=schema_copy.anon,
        derive_state=schema_copy.derive_state,)
...
class CurrentScheme():
    ...
    def set(self,scheme:DiagramSchema):
        if self.current_diagram is not None:
            raise ValueError("Cannot Define a Ladle diagram inside another Ladle diagram")
...
# %% ../nbs/005_diagrams.ipynb 38
from textwrap import indent
import re

# %% ../nbs/005_diagrams.ipynb 39
import ast
import inspect
import re
...
def _validate_diagram_factored(diagram):
    ...
    for node,node_data in graph.nodes(data=True):
        ...
        if isinstance(func,DiagramSchema) and func.anon:
            anon_sub_diagrams.append(func)

    for sub_diagram in anon_sub_diagrams:
        _validate_diagram_factored(sub_diagram)
...
# %% ../nbs/005_diagrams.ipynb 95
from ladle.core import (
    new_combinations,
    merge_list_dicts,
    dict_cartesian_product
    )

# %% ../nbs/005_diagrams.ipynb 96
...
# %% ../nbs/005_diagrams.ipynb 104
@patch
def get_node_func(self:Diagram,node):
    """
    Get the function associated with a node in the diagram.

    Args:
        node: The node identifier to get the function for

    Returns:
        The function associated with the given node in the diagram
    """
    return self.factored_graph.nodes[node]['func']
